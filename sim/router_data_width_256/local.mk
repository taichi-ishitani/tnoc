...
FILE_LISTS	+= $(NOC_SV_HOME)/env/router/compile.f
FILE_LISTS	+= $(NOC_SV_HOME)/test/router/compile.f

SOURCE_FILES	+= $(NOC_SV_HOME)/env/router/top.sv

DEFINES	+= NOC_ROUTER_ENV_DATA_WIDTH=256
